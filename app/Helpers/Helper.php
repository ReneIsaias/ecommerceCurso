...
class Helper
{
    ...
    public static function quantity($product_id, $color_id = null, $size_id = null)
    {
    ...
    public static function qty_added($product_id, $color_id = null, $size_id = null)
    {
    ...
    public static function qty_available($product_id, $color_id = null, $size_id = null)
    {
        /* Hacemos la resta entre estas dos funciones para saber el stock dispobible */
        return Helper::quantity($product_id, $color_id, $size_id) - Helper::qty_added($product_id, $color_id, $size_id);
    }
}
